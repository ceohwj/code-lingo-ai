  ...
  return (
    <main className="app-shell">
      <section className="category-selector">
        ...
        <section className="achievement-panel" aria-label="Achievement summary">
          <div className="achievement-panel-header">
            <div>
              <span>Achievements</span>
              <strong>{achievements.filter((achievement) => achievement.isUnlocked).length} / {achievements.length} unlocked</strong>
            </div>
          </div>
